...
var _user$project$MainMessages$UpdateState = F3(
	function (a, b, c) {
		return {ctor: 'UpdateState', _0: a, _1: b, _2: c};
	});
...
var _user$project$MainModel$Affiliation = F5(
	function (a, b, c, d, e) {
		return {institution: a, city: b, state: c, country: d, id: e};
	});
var _user$project$MainModel$blankAffiliation = function (id) {
	return A5(_user$project$MainModel$Affiliation, '', '', '', '', id);
};
				...
				_1: {
					...
					_1: {
						...
						_0: {
							ctor: '_Tuple2',
							_0: 'state',
							_1: _elm_lang$core$Json_Encode$string(affiliation.state)
						},
						_1: {
							ctor: '::',
							_0: {
